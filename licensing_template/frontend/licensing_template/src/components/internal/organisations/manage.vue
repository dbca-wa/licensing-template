                                  ...
                                  <div class="card-body collapse in" :id="pdBody">
                                      <form class="form-horizontal" name="personal_form" method="post">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="last_name" placeholder="" v-model="org.abn" :disabled="!is_licensing_template_admin">
                                            </div>
                                          </div>
                                          <div class="form-group">
...
export default {
    ...
    data () {
        ...
        return {
            ...
            is_licensing_template_admin:false,
            profile:{},
    ...
    beforeRouteEnter: function(to, from, next){
        ...
        Promise.all(initialisers).then(data => {
            next(vm => {
                ...
                //vm.profile=data[2];
                vm.is_licensing_template_admin=vm.profile.is_licensing_template_admin;
            });
        });
    },
