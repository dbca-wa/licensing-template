...
# from licensing_template.admin import licensing_template_admin_site
from licensing_template.components.proposals import views as proposal_views
from licensing_template.components.organisations import views as organisation_views
from licensing_template.components.bookings import views as booking_views

from licensing_template.components.users import api as users_api
from licensing_template.components.organisations import api as org_api
from licensing_template.components.main import api as main_api
from licensing_template.components.bookings import api as booking_api
from licensing_template.components.proposals import api as proposal_api
from licensing_template.components.approvals import api as approval_api
from licensing_template.components.compliances import api as compliances_api
...
# URL Patterns
urlpatterns = [
    # url(r'^admin/', include(licensing_template_admin_site.urls)),
    # url(r'^admin/', licensing_template_admin_site.urls),
