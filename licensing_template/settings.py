...
ROOT_URLCONF = "licensing_template.urls"
SITE_ID = 1
...
INSTALLED_APPS += [
    ...
    "webtemplate_dbca",
    "licensing_template",
    "licensing_template.components.main",
    "licensing_template.components.organisations",
    "licensing_template.components.users",
    "licensing_template.components.proposals",
    "licensing_template.components.approvals",
    "licensing_template.components.compliances",
    "licensing_template.components.bookings",
    "rest_framework",
...
WSGI_APPLICATION = "licensing_template.wsgi.application"

"""REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': (
        'licensing_template.perms.OfficerPermission',
    )
}"""
...
MIDDLEWARE_CLASSES += [
    #'licensing_template.middleware.BookingTimerMiddleware',
    #'licensing_template.middleware.FirstTimeNagScreenMiddleware',
    #'licensing_template.middleware.RevisionOverrideMiddleware',
    "whitenoise.middleware.WhiteNoiseMiddleware",
]
MIDDLEWARE = MIDDLEWARE_CLASSES
MIDDLEWARE_CLASSES = None

TEMPLATES[0]["DIRS"].append(os.path.join(BASE_DIR, "licensing_template", "templates"))
TEMPLATES[0]["DIRS"].append(
    os.path.join(
        BASE_DIR, "licensing_template", "components", "organisations", "templates"
    )
)
TEMPLATES[0]["DIRS"].append(
    os.path.join(BASE_DIR, "licensing_template", "components", "emails", "templates")
)
TEMPLATES[0]["OPTIONS"]["context_processors"].append(
    "licensing_template.context_processors.licensing_template_url"
)
...
CACHES = {
    "default": {
        ...
        "LOCATION": os.path.join(BASE_DIR, "licensing_template", "cache"),
    }
}
STATIC_ROOT = os.path.join(BASE_DIR, "staticfiles")
STATICFILES_DIRS.extend([
    os.path.join(os.path.join(BASE_DIR, "licensing_template", "static")),
    ])
...
CRON_CLASSES = [
    "licensing_template.cron.OracleIntegrationCronJob",
]
...
# Additional logging for licensing_template
...
# Add a handler
LOGGING["handlers"]["file_licensing_template"] = {
    "level": "INFO",
    "class": "logging.handlers.RotatingFileHandler",
    "filename": os.path.join(BASE_DIR, "logs", "licensing_template.log"),
    "formatter": "verbose",
    "maxBytes": 5242880,
}

LOGGING["loggers"]["licensing_template"] = {
    "handlers": ["file_licensing_template"],
    "level": "INFO",
}
