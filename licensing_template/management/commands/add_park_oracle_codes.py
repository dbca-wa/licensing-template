...
from licensing_template.components.main.models import ApplicationType, Park
import csv
import datetime
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # with open('licensing_template/utils/csv/park_oracle_codes_09Nov2020.csv') as csvfile:
        with open(
            "licensing_template/utils/csv/park_oracle_codes_03Dec2020.csv"
        ) as csvfile:
