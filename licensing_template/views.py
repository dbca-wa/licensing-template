...
class LicensingTemplateRoutingView(TemplateView):
    template_name = "licensing_template/index.html"
...
class LicensingTemplateContactView(TemplateView):
    template_name = "licensing_template/contact.html"


class LicensingTemplateFurtherInformationView(TemplateView):
    template_name = "licensing_template/further_info.html"
...
def first_time(request):
    ...
    if request.method == "POST":
        ...
        return render(request, "licensing_template/user_profile.html", context)
    # GET default
    ...
    context["dev_url"] = settings.DEV_STATIC_URL
    # return render(request, 'licensing_template/user_profile.html', context)
    return render(request, "licensing_template/dash/index.html", context)


class HelpView(LoginRequiredMixin, TemplateView):
    template_name = "licensing_template/help.html"
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.request.user.is_authenticated:
            ...
            #                else:
            #                    return TemplateResponse(self.request, 'licensing_template/not-permitted.html', context)
...
class ManagementCommandsView(LoginRequiredMixin, TemplateView):
    template_name = "licensing_template/mgt-commands.html"
