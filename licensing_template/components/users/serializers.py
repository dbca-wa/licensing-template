...
from licensing_template.components.organisations.utils import can_admin_org, is_consultant
from licensing_template.helpers import is_licensing_template_admin, in_dbca_domain
from rest_framework import serializers

# from ledger.payments.helpers import is_payment_admin
from django.utils import timezone
from datetime import date, timedelta
from licensing_template.components.approvals.models import Approval
...
class UserSerializer(serializers.ModelSerializer):
    # licensing_template_organisations = serializers.SerializerMethodField()
    ...
    is_licensing_template_admin = serializers.SerializerMethodField()
    ...
    class Meta:
        ...
        fields = (
            ...
            "phone_number",
            "mobile_number",
            #'licensing_template_organisations',
            "personal_details",
            "address_details",
            "contact_details",
            "full_name",
    ...
    # def get_licensing_template_organisations(self, obj):
    #    licensing_template_organisations = obj.licensing_template_organisations
    #    serialized_orgs = UserOrganisationSerializer(
    #        licensing_template_organisations, many=True, context={
    #            'user_id': obj.id}).data
    ...
    def get_is_licensing_template_admin(self, obj):
        request = self.context["request"] if self.context else None
        if request:
            return is_licensing_template_admin(request)
        return False
