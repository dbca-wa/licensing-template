...
# from licensing_template.components.main.models import Organisation as ledger_org
from ledger_api_client.country_models import Country
from datetime import datetime, timedelta, date
from django.urls import reverse
from django.shortcuts import render, redirect, get_object_or_404
from licensing_template.components.proposals.models import Proposal, ApplicationType
from licensing_template.components.approvals.models import Approval, ApprovalDocument
from licensing_template.components.approvals.serializers import (
    ApprovalSerializer,
...
class ApprovalPaginatedViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        if is_internal(self.request):
            ...
            # user_orgs = [org.id for org in self.request.user.licensing_template_organisations.all()]
...
class ApprovalViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        if is_internal(self.request):
            ...
            user_orgs = [
                org.id for org in self.request.user.licensing_template_organisations.all()
            ]
