...
class ApprovalExpireNotificationEmail(TemplateEmailBase):
    ...
    html_template = "licensing_template/emails/approval_expire_notification.html"
    txt_template = "licensing_template/emails/approval_expire_notification.txt"
...
class FilmingLawfulAuthorityApprovalExpireNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "licensing_template/emails/approval_lawful_authority_expire_notification.html"
    )
    txt_template = (
        "licensing_template/emails/approval_lawful_authority_expire_notification.txt"
    )
...
class FilmingLicenceApprovalExpireNotificationEmail(TemplateEmailBase):
    ...
    html_template = "licensing_template/emails/approval_filming_expire_notification.html"
    txt_template = "licensing_template/emails/approval_filming_expire_notification.txt"
...
class ApprovalCancelNotificationEmail(TemplateEmailBase):
    ...
    html_template = "licensing_template/emails/approval_cancel_notification.html"
    txt_template = "licensing_template/emails/approval_cancel_notification.txt"
...
class ApprovalSuspendNotificationEmail(TemplateEmailBase):
    ...
    html_template = "licensing_template/emails/approval_suspend_notification.html"
    txt_template = "licensing_template/emails/approval_suspend_notification.txt"
...
class ApprovalSurrenderNotificationEmail(TemplateEmailBase):
    ...
    html_template = "licensing_template/emails/approval_surrender_notification.html"
    txt_template = "licensing_template/emails/approval_surrender_notification.txt"
...
class ApprovalReinstateNotificationEmail(TemplateEmailBase):
    ...
    html_template = "licensing_template/emails/approval_reinstate_notification.html"
    txt_template = "licensing_template/emails/approval_reinstate_notification.txt"
...
class ApprovalRenewalNotificationEmail(TemplateEmailBase):
    ...
    html_template = "licensing_template/emails/approval_renewal_notification.html"
    txt_template = "licensing_template/emails/approval_renewal_notification.txt"
...
class ApprovalEclassRenewalNotificationEmail(TemplateEmailBase):
    ...
    html_template = "licensing_template/emails/approval_eclass_renewal_notification.html"
    txt_template = "licensing_template/emails/approval_eclass_renewal_notification.txt"
...
class ApprovalEclassExpiryNotificationEmail(TemplateEmailBase):
    ...
    html_template = "licensing_template/emails/approval_eclass_expiry_notification.html"
    txt_template = "licensing_template/emails/approval_eclass_expiry_notification.txt"
...
def _log_approval_email(email_message, approval, sender=None):
    from licensing_template.components.approvals.models import ApprovalLogEntry
