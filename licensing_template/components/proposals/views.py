...
from licensing_template.components.proposals.utils import create_data_from_form
...
class ProposalView(TemplateView):
    template_name = "licensing_template/proposal.html"
...
#    """
#    model = Proposal
#    template_name = 'licensing_template/reversion_history.html'
#
#
...
from licensing_template.components.proposals.utils import test_proposal_emails
