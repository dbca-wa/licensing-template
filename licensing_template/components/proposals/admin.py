...
class HelpPageAdmin(admin.ModelAdmin):
    ...
    change_list_template = "licensing_template/help_page_changelist.html"
    ...
    def get_urls(self):
        ...
        my_urls = [
            url(
                "create_licensing_template_help/",
                self.admin_site.admin_view(self.create_licensing_template_help),
            ),
            url(
                "create_licensing_template_help_assessor/",
                self.admin_site.admin_view(self.create_licensing_template_help_assessor),
            ),
        ]
        return my_urls + urls

    def create_licensing_template_help(self, request):
        create_helppage_object(
            application_type="T Class", help_type=models.HelpPage.HELP_TEXT_EXTERNAL
        )
        return HttpResponseRedirect("../")

    def create_licensing_template_help_assessor(self, request):
        create_helppage_object(
