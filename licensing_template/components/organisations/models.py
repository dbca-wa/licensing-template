...
# from licensing_template.components.main.models import Organisation as ledger_organisation, RevisionedMixin
...
from licensing_template.components.organisations.utils import (
    random_generator,
    can_admin_org,
    has_atleast_one_admin,
)
from licensing_template.components.organisations.emails import (
...
class Organisation(models.Model):
    ...
    # delegates = models.ManyToManyField(EmailUser, blank=True, through='UserDelegation', related_name='licensing_template_organisations')
...
class OrganisationRequest(models.Model):
    ...
    def __accept(self, request):
        ...
        # Create Organisation in licensing_template
