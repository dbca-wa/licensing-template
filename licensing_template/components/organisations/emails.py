...
class OrganisationRequestAcceptNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "licensing_template/emails/organisation_request_accept_notification.html"
    )
    txt_template = "licensing_template/emails/organisation_request_accept_notification.txt"
...
class OrganisationAccessGroupRequestAcceptNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "licensing_template/emails/org_access_group_request_accept_notification.html"
    )
    txt_template = (
        "licensing_template/emails/org_access_group_request_accept_notification.txt"
    )
...
class OrganisationRequestNotificationEmail(TemplateEmailBase):
    ...
    html_template = "licensing_template/emails/organisation_request_notification.html"
    txt_template = "licensing_template/emails/organisation_request_notification.txt"


class OrganisationRequestDeclineNotificationEmail(TemplateEmailBase):
    subject = "Your organisation request has been declined."
    html_template = (
        "licensing_template/emails/organisation_request_decline_notification.html"
    )
    txt_template = (
        "licensing_template/emails/organisation_request_decline_notification.txt"
    )


class OrganisationLinkNotificationEmail(TemplateEmailBase):
    subject = "{} - Confirmation - Account linked.".format(settings.DEP_NAME)
    html_template = "licensing_template/emails/organisation_link_notification.html"
    txt_template = "licensing_template/emails/organisation_link_notification.txt"


class OrganisationUnlinkNotificationEmail(TemplateEmailBase):
    subject = "You have been unlinked from an organisation."
    html_template = "licensing_template/emails/organisation_unlink_notification.html"
    txt_template = "licensing_template/emails/organisation_unlink_notification.txt"


class OrganisationContactAdminUserNotificationEmail(TemplateEmailBase):
    subject = "You have been linked as Company Admin Role."
    html_template = (
        "licensing_template/emails/organisation_contact_admin_notification.html"
    )
    txt_template = "licensing_template/emails/organisation_contact_admin_notification.txt"


class OrganisationContactUserNotificationEmail(TemplateEmailBase):
    subject = "You have been linked as Company User Role."
    html_template = "licensing_template/emails/organisation_contact_user_notification.html"
    txt_template = "licensing_template/emails/organisation_contact_user_notification.txt"


class OrganisationContactSuspendNotificationEmail(TemplateEmailBase):
    subject = "You have been suspended as Company User."
    html_template = (
        "licensing_template/emails/organisation_contact_suspend_notification.html"
    )
    txt_template = (
        "licensing_template/emails/organisation_contact_suspend_notification.txt"
    )
...
class OrganisationContactReinstateNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "licensing_template/emails/organisation_contact_reinstate_notification.html"
    )
    txt_template = (
        "licensing_template/emails/organisation_contact_reinstate_notification.txt"
    )
...
class OrganisationContactDeclineNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "licensing_template/emails/organisation_contact_decline_notification.html"
    )
    txt_template = (
        "licensing_template/emails/organisation_contact_decline_notification.txt"
    )
...
class OrganisationAddressUpdatedNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "licensing_template/emails/organisation_address_updated_notification.html"
    )
    txt_template = (
        "licensing_template/emails/organisation_address_updated_notification.txt"
    )


class OrganisationIdUploadNotificationEmail(TemplateEmailBase):
    subject = "An organisation" "s identification has been uploaded"
    html_template = "licensing_template/emails/organisation_id_upload_notification.html"
    txt_template = "licensing_template/emails/organisation_id_upload_notification.txt"
...
class OrganisationRequestLinkNotificationEmail(TemplateEmailBase):
    ...
    html_template = "licensing_template/emails/organisation_request_link_notification.html"
    txt_template = "licensing_template/emails/organisation_request_link_notification.txt"
...
def send_organisation_address_updated_email_notification(
    ...
    from licensing_template.components.organisations.models import OrganisationContact
