...
# from licensing_template.components.main.models import Organisation, OrganisationAddress
...
from licensing_template.helpers import is_licensing_template_admin
...
#            if not is_licensing_template_admin(request):
