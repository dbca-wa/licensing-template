...
class ComplianceExternalSubmitSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = "licensing_template/emails/send_external_submit_notification.html"
    txt_template = "licensing_template/emails/send_external_submit_notification.txt"


class ComplianceSubmitSendNotificationEmail(TemplateEmailBase):
    subject = "A new Compliance has been submitted."
    html_template = "licensing_template/emails/send_submit_notification.html"
    txt_template = "licensing_template/emails/send_submit_notification.txt"
...
class ComplianceAcceptNotificationEmail(TemplateEmailBase):
    ...
    html_template = "licensing_template/emails/compliance_accept_notification.html"
    txt_template = "licensing_template/emails/compliance_accept_notification.txt"
...
class ComplianceAmendmentRequestSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = "licensing_template/emails/send_amendment_notification.html"
    txt_template = "licensing_template/emails/send_amendment_notification.txt"
...
class ComplianceReminderNotificationEmail(TemplateEmailBase):
    ...
    html_template = "licensing_template/emails/send_reminder_notification.html"
    txt_template = "licensing_template/emails/send_reminder_notification.txt"
...
class ComplianceInternalReminderNotificationEmail(TemplateEmailBase):
    ...
    html_template = "licensing_template/emails/send_internal_reminder_notification.html"
    txt_template = "licensing_template/emails/send_internal_reminder_notification.txt"
...
class ComplianceDueNotificationEmail(TemplateEmailBase):
    ...
    html_template = "licensing_template/emails/send_due_notification.html"
    txt_template = "licensing_template/emails/send_due_notification.txt"
...
class ComplianceInternalDueNotificationEmail(TemplateEmailBase):
    ...
    html_template = "licensing_template/emails/send_internal_due_notification.html"
    txt_template = "licensing_template/emails/send_internal_due_notification.txt"
...
class ComplianceNotificationOnlyEmail(TemplateEmailBase):
    ...
    html_template = "licensing_template/emails/send_notification_only_email.html"
    txt_template = "licensing_template/emails/send_notification_only_email.txt"


class ComplianceInternalNotificationOnlyEmail(TemplateEmailBase):
    subject = "A Compliance with requirements is due for submission."
    html_template = "licensing_template/emails/send_internal_notification_only_email.html"
    txt_template = "licensing_template/emails/send_internal_notification_only_email.txt"
...
def _log_compliance_email(email_message, compliance, sender=None):
    from licensing_template.components.compliances.models import ComplianceLogEntry
