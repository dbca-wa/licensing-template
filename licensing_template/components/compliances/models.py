...
from licensing_template.components.compliances.email import (
...
class Compliance(models.Model):
    ...
    proposal = models.ForeignKey(
        "licensing_template.Proposal", related_name="compliances", on_delete=models.CASCADE
    )
    approval = models.ForeignKey(
        "licensing_template.Approval", related_name="compliances", on_delete=models.CASCADE
    )
    ...
    # assigned_to = models.ForeignKey(EmailUser,related_name='licensing_template_compliance_assignments',null=True,blank=True, on_delete=models.SET_NULL)
    ...
    # submitter = models.ForeignKey(EmailUser, blank=True, null=True, related_name='licensing_template_compliances', on_delete=models.SET_NULL)
