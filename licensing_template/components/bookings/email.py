...
from licensing_template.components.bookings.invoice_pdf import create_invoice_pdf_bytes
from licensing_template.components.bookings.confirmation_pdf import (
    create_confirmation_pdf_bytes,
)
from licensing_template.components.bookings.monthly_confirmation_pdf import (
    create_monthly_confirmation_pdf_bytes,
)
from licensing_template.components.bookings.models import Booking
...
class ComplianceFeeInvoiceEventsSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "licensing_template/emails/bookings/events/send_compliance_fee_notification.html"
    )
    txt_template = (
        "licensing_template/emails/bookings/events/send_compliance_fee_notification.txt"
    )
...
#    html_template = 'licensing_template/emails/bookings/filming/send_filming_fee_awaiting_payment_notification.html'
#    txt_template = 'licensing_template/emails/bookings/filmig/send_filming_fee_awaiting_payment_notification.txt'


class ApplicationInvoiceFilmingSendNotificationEmail(TemplateEmailBase):
    subject = "Your filming fee invoice."
    html_template = (
        "licensing_template/emails/bookings/filming/send_filming_fee_notification.html"
    )
    txt_template = (
        "licensing_template/emails/bookings/filmig/send_filming_fee_notification.txt"
    )
...
class ApplicationFeeInvoiceTClassSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "licensing_template/emails/bookings/tclass/send_application_fee_notification.html"
    )
    txt_template = (
        "licensing_template/emails/bookings/tclass/send_application_fee_notification.txt"
    )


class ApplicationFeeConfirmationTClassSendNotificationEmail(TemplateEmailBase):
    subject = "Your application fee confirmation."
    html_template = "licensing_template/emails/bookings/tclass/send_application_fee_confirmation_notification.html"
    txt_template = "licensing_template/emails/bookings/tclass/send_application_fee_confirmation_notification.txt"


class InvoiceTClassSendNotificationEmail(TemplateEmailBase):
    subject = "Your booking invoice."
    html_template = (
        "licensing_template/emails/bookings/tclass/send_invoice_notification.html"
    )
    txt_template = (
        "licensing_template/emails/bookings/tclass/send_invoice_notification.txt"
    )
...
class MonthlyInvoiceTClassSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "licensing_template/emails/bookings/tclass/send_monthly_invoice_notification.html"
    )
    txt_template = (
        "licensing_template/emails/bookings/tclass/send_monthly_invoice_notification.txt"
    )
...
class ConfirmationTClassSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "licensing_template/emails/bookings/tclass/send_confirmation_notification.html"
    )
    txt_template = (
        "licensing_template/emails/bookings/tclass/send_confirmation_notification.txt"
    )


class MonthlyInvoicesFailedTClassEmail(TemplateEmailBase):
    subject = "Failed: COLS Monthly Invoices."
    html_template = "licensing_template/emails/bookings/tclass/send_monthly_invoices_failed_notification.html"
    txt_template = "licensing_template/emails/bookings/tclass/send_monthly_invoices_failed_notification.txt"


class SendPaymentDueNotificationTClassEmail(TemplateEmailBase):
    subject = "COLS Monthly/BPAY Bookings Invoices Overdue."
    html_template = (
        "licensing_template/emails/bookings/tclass/send_payment_due_notification.html"
    )
    txt_template = (
        "licensing_template/emails/bookings/tclass/send_payment_due_notification.txt"
    )


class SendExternalPaymentDueNotificationTClassEmail(TemplateEmailBase):
    subject = "Your booking invoice is overdue."
    html_template = "licensing_template/emails/bookings/tclass/send_external_payment_due_notification.html"
    txt_template = "licensing_template/emails/bookings/tclass/send_external_payment_due_notification.txt"


class PaymentDueNotificationFailedTClassEmail(TemplateEmailBase):
    subject = "Failed: COLS Payment Due Notifications"
    html_template = "licensing_template/emails/bookings/tclass/send_external_payment_due_notification_failed.html"
    txt_template = "licensing_template/emails/bookings/tclass/send_external_payment_due_notification_failed.txt"
...
def _log_proposal_email(email_message, proposal, sender=None):
    from licensing_template.components.proposals.models import ProposalLogEntry
...
def _log_org_email(email_message, organisation, customer, sender=None):
    from licensing_template.components.organisations.models import OrganisationLogEntry
