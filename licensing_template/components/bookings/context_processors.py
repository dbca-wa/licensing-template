...
from licensing_template import helpers


def licensing_template_url(request):
    web_url = request.META["HTTP_HOST"]
    template_group = "licensing_template"
    TERMS = "/know/online-licensing_template-booking-terms-and-conditions"
    ...
    if request.user.is_authenticated:
        ...
        is_admin = helpers.is_licensing_template_admin(request)
...
def template_context(request):
    ...
    context = licensing_template_url(request)
    return context
