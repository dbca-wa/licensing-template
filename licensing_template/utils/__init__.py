...
def search_all(search_list, application_type="T Class"):
    """
    To run:
            from licensing_template.utils import search_all
            search_all(['BRM', 'JM 1'])
    """
    result = {}
...
def search(dictionary, search_list):
    """
    To run:
            from licensing_template.utils import search
...
def compare_data(dict1, dict2, schema):
    ...
    To run:
            from licensing_template.utils import compare
...
def search_keys(dictionary, search_list=["help_text", "label"]):
    ...
    To run:
            from licensing_template.utils import search_keys
