...
FROM ubuntu:20.04 as builder_base_licensing_template
...
RUN touch /app/.env
COPY licensing_template ./licensing_template
#RUN mkdir /app/licensing_template/cache/
#RUN chmod 777 /app/licensing_template/cache/
